...
<div class="row"><div class="d-none d-sm-block col-lg-3"> </div> <!-- col3 concluded --><div class="col-lg-6 col-12" >
						...
						<!---------------->
							...
							<div id="regress" class="col-lgg-6 col-mdd-6 col-smm-12 col-6 f-slight spacer fat f-box1-heading1">
				...
				<!-----------------------------------------------------------------> 
					...
					</div><div class="d-none d-sm-block col-lg-3 "> </div> </div>					
			...
			<div class="row"><div class="col-lg-6 "><div class="row" style="height:auto;"> 
						...
						<!---------------->
							...
							<div id="geometri&shy;cize" class="col-lgg-6 col-mdd-6 col-smm-12 col-6 f-slight spacer fat f-box1-heading1">
				...
				<!-----------------------------------------------------------------> 
					...
					</div><div class="col-12 d-sm-none d-md-none d-lg-none d-xl-none">
						...
						<!---------------->
							...
							<div id="bridge" class="col-lgg-6 col-mdd-6 col-smm-12 col-6 f-slight spacer fat f-box1-heading1">
					...
					<div class="row">
						...
						<div class="col-5 col-lg-2  col-mdd-3 ">
							...
							<div class=""> 
								 ...
								 <svg  preserveAspectRatio="xMidYMid meet" viewBox="0 0 190 434">
									<circle r="217" cx="217" cy="217" fill="red" />
								</svg>   
						...
						<div class="col-5 col-lg-2  col-mdd-3 ">
							...
							<div class=""> 
								 ...
								 <svg preserveAspectRatio="xMidYMid meet" viewBox="0 0 190 434">
									<circle r="217" cx="217" cy="217" fill="#00FF00" />
								</svg>   
					...
					<div class="row">
						...
						<div class="col-5 col-lg-2  col-mdd-3 ">
							...
							<div class=""> 
								 ...
								 <svg  preserveAspectRatio="xMidYMid meet" viewBox="0 0 217 434">
									<circle r="217" cx="0" cy="217" fill="#0000FF" />
								</svg>   
						...
						<div class="col-5 col-lg-2  col-mdd-3 ">
							...
							<div class=""> 
								 ...
								 <svg  preserveAspectRatio="xMidYMid meet" viewBox="0 0  217  434">
									<circle r="217" cx="0" cy="217" fill="red" />
								</svg>   
					...
					<div class="row">
						...
						<div class="col-5 col-lg-2  col-mdd-3 ">
							...
							<div class=""> 
								 ...
								 <svg  preserveAspectRatio="xMidYMid meet" viewBox="0 0 190 434">
									<circle r="217" cx="217" cy="217" fill="#0000FF" />
								</svg>   
				...
				<!-----------------------------------------------------------------> 
						...
						<div class="col-5 col-lg-2  col-mdd-3 ">
							...
							<div class=""> 
								 ...
								 <svg  preserveAspectRatio="xMidYMid meet" viewBox="0 0  217  434">
									<circle r="217" cx="0" cy="217" fill="#00FF00" />
								</svg>   
					...
					<div class="row">
						...
						<div class="col-5 col-lg-2  col-mdd-3 " style="margin-bottom: 122px;">
							...
							<div class=""> 
								 ...
								 <svg  preserveAspectRatio="xMidYMid meet" viewBox="0 0 217 217">
									<circle r="217" cx="0" cy="217" fill="red" />
								</svg>   
					...
					<div class="row">
						...
						<div class="col-5 col-lg-2  col-mdd-3 " style="margin-bottom:122px;">
							...
							<div class=""> 
								 ...
								 <svg  preserveAspectRatio="xMidYMid meet" viewBox="0 0 217 217">
									<circle r="217" cx="217" cy="217" fill="blue" />
								</svg>   
			...
			display: flex;
					...
					border: 3px solid #0000ff;
						...
						<div class="row">
							...
							<div class="col-12 col-lg-5 col-md-6 col-sm-6">
								...
								<div class="row">
									...
									<div style="padding-left: 15px;" class=" col-6 col-lg-4 col-md-12 col-sm-12 fat text-left text-black bg-white spacer f-slight f- " >
														...
														<div class="box cube-red">
															<div class="box cube-red">
																<div class="box cube-red"></div>
															</div>
														</div>									

									</div>

									<div class=" col-3 d-xs-block  d-sm-none d-md-none d-lg-none d-xlg-none  "></div><div class=" col-2 d-xs-block  d-sm-none d-md-none d-lg-none d-xlg-none  "></div>
									
									<div class=" lh-45 f-remedial-heading col-8 col-lg-8 col-md-12 col-sm-12  fat text-center text-sm-left text text-md-left text-lg-left text-black bg-white spacer f-slight " >
								
								
								<div class="row"><div class="col-12 d-lg-none">
							...
							<!-----------------------------------------------------------------> 
									...
									<div class=" col-2 d-xs-block  d-sm-none d-md-none d-lg-none d-xlg-none  "></div>
							...
							<!-----------------------------------------------------------------> 
								...
								<div class="row">
									...
									<div class=" col-1 d-xs-block  d-sm-none d-md-none col-lg-2 d-lg-block  d-xlg-none  "></div>									
								 
									<div class="  lh-45 f-18 col-10 col-lg-10 col-md-12 col-sm-12 text-center text-sm-left text-md-left text-lg-left text-black bg-white spacer f-slight  "  >		
									...
									<div class=" col-1 d-xs-block  d-sm-none d-md-none d-lg-none d-xlg-none  "></div>									
								</div>
							...
							<!-----------------------------------------------------------------> 
								...
								<div class="row">
									...
									<div class=" col-3 d-xs-block  d-sm-none d-md-none col-lg-3 d-lg-block  d-xlg-none  "></div>
										<div class=" col-6 col-lg-9 col-md-12 col-sm-12 text-left text-black bg-white spacer f-slight  " style="font-size:18px; line-height:45px;">		 
														...
														<div data-more="" class=" rmbox cube-red">
															<div class="rmbox cube-red"> 
																<div data-more="Read more..." id="remedialservice1" class="cardpack stack-content">Read more...</div>
															</div>
														</div>
										</div>
							...
							<!-----------------------------------------------------------------> 
								...
								<div class="row">
									...
									<div class=" col-3 d-xs-block  d-sm-none d-md-none d-lg-none d-xlg-none  "></div>
									<div style="padding-left: 15px;"  class=" col-6 col-lg-4 col-md-12 col-sm-12 fat text-left text-black bg-white spacer f-slight f- " >
									
											
																	
														<div class="box cube-green">
															<div class="box cube-green">
																<div class="box cube-green"></div>
															</div>
														</div> 
							...
							<!-----------------------------------------------------------------> 
								...
								<div class="row">
									...
									<div class=" col-6 col-lg-4 col-md-12 col-sm-12 text-left text-black bg-white spacer f-slight  " style="font-size:18px; line-height:45px;">						
														...
														<div data-more="" class=" rmbox cube-green">
															<div class="rmbox cube-green"> 
																<div data-more="Read more..." id="remedialservice2" class="cardpack stack-content">Read more...</div>
															</div>
														</div>
									</div>
							...
							<div class="col-12 col-lg-5 col-md-6 col-sm-6">
								...
								<div class="row">
									...
									<div style="padding-left: 15px;" class=" col-6 col-lg-4 col-md-12 col-sm-12 fat text-left text-black bg-white spacer f-slight f- " >
														...
														<div class="box cube-blue">
															<div class="box cube-blue">
																<div class="box cube-blue"></div>
															</div>
														</div>									
							...
							<!-----------------------------------------------------------------> 
								...
								<div class="row">
									...
									<div class=" col-6 col-lg-9 col-md-12 col-sm-12 text-left text-black bg-white spacer f-slight  " style="font-size:18px; line-height:45px;">		 
														...
														<div data-more="" class=" rmbox cube-blue">
															<div class="rmbox cube-blue"> 
																<div data-more="Read more..." id="remedialservice3" class="cardpack stack-content">Read more...</div>
															</div>
														</div>
									</div>
							...
							<!-----------------------------------------------------------------> 
								...
								<div class="row">
									...
									<div class=" col-6 col-lg-4 col-md-12 col-sm-12 text-left text-black bg-white spacer f-slight  " style="font-size:18px; line-height:45px;">						
														...
														<div data-more="" class=" rmbox cube-red">
															<div class="rmbox cube-red"> 
																<div data-more="Read more..." id="remedialservice4" class="cardpack stack-content">Read more...</div>
															</div>
														</div>
									</div>
				...
				<!-----------------------------------------------------------------> 
						...
						<div class="row">
							...
							<!-----------------------------------------------------------------> 
										...
										Student attrition research to student retention									
									</div>
							...
							<!-----------------------------------------------------------------> 
								...
								<div class="row">
									...
									<div class=" col-6 col-lg-9 col-md-12 col-sm-12 text-left text-black bg-white spacer f-slight  " style="font-size:18px; line-height:45px;">		 
														...
														<div data-more="" class=" rmbox cube-green">
															<div class="rmbox cube-green"> 
																<div data-more="Read more..." id="remedialservice5" class="cardpack stack-content">Read more...</div>
															</div>
														</div>
									</div>
							...
							<!-----------------------------------------------------------------> 
								...
								<div class="row">
									...
									<div class=" col-6 col-lg-4 col-md-12 col-sm-12 text-left text-black bg-white spacer f-slight  " style="font-size:18px; line-height:45px;">						
														...
														<div data-more="" class=" rmbox cube-blue">
															<div class="rmbox cube-blue"> 
																<div data-more="Read more..." id="remedialservice6" class="cardpack stack-content">Read more...</div>
															</div>
														</div>
									</div>
				...
				<!-------------------------- cube design --------------------------> 
					...
					<div class="col-6 col-lg-10">			
						...
						<div class="row">		
							<div id="tech-readmore1"   data-more="read more" class="tech-readmore f-18 col-12 col-lg-6 col-md-6 col-sm-6 text-center text-black spacer f-slight " >
								...
								<div class="row">
									...
									<div class="col-4">
										...
										<div class="row" style=" ">
											...
											<div class="col-6" style="background-color: red; height: 33px;">

											</div>

										 
											<div class="col-6" style="background-color: blue; height: 33px;">
					...
					<div class="col-6 col-lg-10">			
						...
						<div class="row">		
							<div id="tech-readmore2"   data-more="read more" class="tech-readmore f-18 col-12 col-lg-6 col-md-6 col-sm-6 text-center text-black spacer f-slight " >
				...
				<!-----------------------------------------------------------------> 
					...
					<div class="col-6 col-lg-10">			
						...
						<div class="row">		
							<div id="tech-readmore3"   data-more="read more" class="tech-readmore f-18 col-12 col-lg-6 col-md-6 col-sm-6 text-center text-black spacer f-slight " >
					...
					<div class="col-6 col-lg-10">			
						...
						<div class="row">		
							<div id="tech-readmore4"   data-more="read more" class="tech-readmore f-18 col-12 col-lg-6 col-md-6 col-sm-6 text-center text-black spacer f-slight " >
